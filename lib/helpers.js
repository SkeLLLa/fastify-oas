...
//     return obj.map(mapProps);
//   }
//   if (typeof obj === 'object') {
//     return Object.keys(obj).reduce((newObj, key) => {
//       if (typeof obj[key] === 'object') {
//         newObj[key] = mapProps(obj[key]);
//       } else {
//         switch (key) {
//           case 'min':
//             newObj.minimum = obj[key];
//             break;
//           case 'max':
//             newObj.maximum = obj[key];
//             break;
//           default:
//             newObj[key] = obj[key];
//             break;
...
exports.genResponse = (dst, src, produces) => {
  if (!src) {
    dst = {200: {description: 'Default Response'}};
    return;
  }
  ...
  Object.keys(src).forEach((key) => {
    if (src[key].type) {
      let rsp = src[key];
      let description = src[key].description;
      let headers = src[key].headers;
      ...
      dst[key].description = description || 'Default Response';
      if (headers) dst[key].headers = headers;
    }
  });
};
