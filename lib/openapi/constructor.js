...
module.exports = ({options = {}, getSchemas = null, routes = []} = {}) => {
  try {
  ...
  const handler = (opts = {}) => {
    ...
    const {yaml, swagger, openapi, addModels} = Object.assign(
      {yaml: false, swagger: {}, openapi: DEFAULTS.openapi, addModels: false},
      options,
      opts
    );
